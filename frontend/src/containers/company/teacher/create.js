...
const CreateDialog = (props) => {
  ...
  return (
    <>
      <Button className={classes.button} style={{marginBottom: 10, float: 'right'}} variant="outlined" onClick={handleClickOpen}>Invite Teacher</Button>
      ...
      <Dialog 
        ...
        maxWidth='sm'
      >
        <DialogTitle id="form-dialog-title">Invite Teacher</DialogTitle>
        <DialogContent>
          <DialogContentText>
            please input data
          </DialogContentText>
