...
const columns = [
  ...
  { id: 'facebook', label: 'Facebook', minWidth: 100 },
...
const Helper = () => {
  ...
  return (
    <Paper className={classes.root}>
      ...
      <div className={classes.title}>Helper Setting</div>
      ...
      <TableContainer className={classes.container} style={{fontSize: 15}}>
          <Table stickyHeader aria-label="sticky table">
            ...
            <TableBody>
              {helpers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, index) => {
                return (
