...
const CreateDialog = (props) => {
  ...
  return (
    <>
      <Button className={classes.button} style={{marginBottom: 10, float: 'right'}} variant="outlined" onClick={handleClickOpen}>Add Exam</Button>
      ...
      <Dialog 
        ...
        maxWidth='sm'
      >
        <DialogTitle id="form-dialog-title">Add Exam {name}</DialogTitle>
        <DialogContent>
          <DialogContentText>
            Page data
          </DialogContentText>
